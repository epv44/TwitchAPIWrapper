...
class Fixtures {
    ...
    class func leaderboard() -> Leaderboard {
        ...
        let date = ISO8601DateFormatter().date(from: "2018-02-05T08:00:00Z")!
    ...
    class func game() -> Game {
        let game = Game(id: "493057", name: "PLAYERUNKNOWN'S BATTLEGROUNDS", boxArtURL: URL(string: "https://www.google.com")!)
        return game
    }
